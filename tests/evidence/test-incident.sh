...
unknown_key="$evidence_dir/fixtures/invalid/incident-unknown-key.kv"
...
expect_failure "unknown incident field" \
    "$validator" "$unknown_key"
expect_failure "malformed incident record line" \
    "$validator" "$malformed_line"
