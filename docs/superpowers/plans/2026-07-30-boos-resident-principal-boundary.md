...
- Produces: `PrincipalDefinition { id: PrincipalId, user: String, uid: u32, enabled: bool }`
...
- [ ] **Step 2: Synchronize and verify RED remotely**
...
- [ ] **Step 3: Implement the principal module**
...
- [ ] **Step 3: Route memory through the principal context**
...
- [ ] **Step 1: Write failing queue ownership tests**
...
- [ ] **Step 3: Implement per-principal spools**
...
- [ ] **Step 3: Implement and wire resident mode**
...
- [ ] **Step 1: Write failing boot verification**
...
- [ ] **Step 2: Verify RED without compiling locally**
...
- [ ] **Step 3: Implement rootfs ownership and daemon configuration**
...
- [ ] **Step 1: Verify each artifact has no live caller**
...
- [ ] **Step 2: Delete dead artifacts and update documentation**
...
- [ ] **Step 3: Run complete remote verification**
...
- [ ] **Step 1: Review dependency direction**
...
- [ ] **Step 2: Review failure boundaries**

Verify malformed config, duplicate IDs, UID mismatch, missing directories,
queue publication failure, status publication failure, and daemon restart are
observable and fail closed.

- [ ] **Step 3: Push one release candidate and inspect CI**
...
- [ ] **Step 4: Mark completed plan checkboxes and commit evidence-only updates**
